        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 order-2 bg-white">
                    <div class="p-4 m-3">
                        <img src="{{ asset('logo-pratista.png') }}" alt="logo" width="60"
                            class="shadow-light rounded-circle mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Pratista
                            </span>
                        </h4>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group text-left">
                                ...
                                <button type="submit" class="btn btn-primary btn-lg btn-icon icon-right"
                                    tabindex="4">
                                    <i class="fas fa-sm fa-sign-in-alt"></i>   Login
                                </button>
                            </div>
                ...
                <div
                    class="col-lg-8 col-12 order-lg-2 order-1 min-vh-50 background-walk-y position-relative overlay-gradient-bottom login">
